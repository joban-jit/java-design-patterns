...
// combining Adapter and Decorator desgin pattern
...
class MyStringBuilder{
    ...
    // we added this method to act as Adapter as we are converting StringBuilder to MyStringBuilder
    ...
    // by implementing below methods we have implemented Decorator design pattern
    // (all the methods of StringBuilder class) as we can't inherit them as we can' extend
    // StringBuilder because StringBuilder is final class
    // now problem is here when we generate all the methods it is returning StringBuilder not MyStringBuilder
    public StringBuilder append(Object obj) {
        return sb.append(obj);
    }
    // we can resolve above issue by doing this
